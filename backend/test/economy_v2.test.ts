...
test("v2 migration is repeatable and leaves legacy single-mint rows untouched", () => {
  ...
  try {
    ...
    assert.deepEqual(migrate(db), ["0005_economy_v2.sql", "0006_game_identity.sql", "0007_game_pairing.sql", "0008_admin_workflow.sql", "0009_beta_operations.sql", "0010_anti_sybil.sql", "0011_watchtower_memory_mac.sql"]);
