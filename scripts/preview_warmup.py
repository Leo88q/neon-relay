...
def render(destination):
    ...
    scale=18
    sections=[('01 / ПОДЪЁМ',0,45),('02 / ПРЫЖКИ',43,88),
              ('03 / ТРЕНИРОВКА КРЮКА',87,128),('04 / ФИНИШ',133,174)]
    font=ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf',18)
    small=ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf',14)
    sheet=Image.new('RGB',(1680,1220),(14,10,25));d=ImageDraw.Draw(sheet)
    d.text((28,18),'РАЗОГРЕВ / ОРИГИНАЛЬНЫЙ МАРШРУТ / PLAYTEST 2',font=font,fill=(224,214,246))
