...
for file in local_server.cpp effects.cpp menus.cpp menus_start.cpp menus_settings.cpp menus_settings_wallet.cpp players.cpp skins.cpp skins7.cpp binds.cpp touch_controls.cpp scoreboard.cpp motd.cpp important_alert.cpp menus_settings_tee.cpp menus_settings_controls.cpp menus_ingame_touch_controls.cpp ghost.cpp menus_settings_appearance.cpp chat.cpp sounds.cpp console.cpp menus_settings_assets.cpp mapimages.cpp; do
