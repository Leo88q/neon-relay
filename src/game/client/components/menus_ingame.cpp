...
void CMenus::RenderPlayers(CUIRect MainView)
{
	...
	PlayerList.Draw(ColorRGBA(0.10f, 0.11f, 0.13f, 0.94f), IGraphics::CORNER_ALL, 6.0f);
...
void CMenus::RenderServerInfo(CUIRect MainView)
{
	...
	ServerInfo.Draw(ColorRGBA(0.10f, 0.11f, 0.13f, 0.94f), IGraphics::CORNER_ALL, 6.0f);
	...
	GameInfo.Draw(ColorRGBA(0.10f, 0.11f, 0.13f, 0.94f), IGraphics::CORNER_ALL, 6.0f);
...
void CMenus::RenderServerInfoMotd(CUIRect Motd)
{
	...
	Motd.Draw(ColorRGBA(0.10f, 0.11f, 0.13f, 0.94f), IGraphics::CORNER_ALL, 6.0f);
