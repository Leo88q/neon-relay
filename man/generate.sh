...
do
    a2x --doctype manpage --format $FORMAT NeonRelay.adoc
    a2x --doctype manpage --format $FORMAT NeonRelayServer.adoc
done
EOF

a2x --doctype manpage --format manpage NeonRelay.adoc
a2x --doctype manpage --format manpage NeonRelayServer.adoc
